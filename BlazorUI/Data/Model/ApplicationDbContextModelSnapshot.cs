...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Helium.BlazorUI.Entities.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("Helium.BlazorUI.Entities.Configuration", b =>
                {
            ...
            modelBuilder.Entity("Helium.BlazorUI.Entities.DiscordAuthor", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Helium.BlazorUI.Entities.DiscordChannel", b =>
                {
            ...
            modelBuilder.Entity("Helium.BlazorUI.Entities.DiscordEmbed", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Helium.BlazorUI.Entities.DiscordEmbedFields", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Helium.BlazorUI.Entities.DiscordGuild", b =>
                {
                    b.Property<decimal>("Id")
                        .HasColumnType("decimal(20,0)");
            ...
            modelBuilder.Entity("Helium.BlazorUI.Entities.DiscordMessageComponent", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Helium.BlazorUI.Entities.DiscordModal", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Helium.BlazorUI.Entities.DiscordModalComponent", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Helium.BlazorUI.Entities.DiscordStatsMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Helium.BlazorUI.Entities.HLLGame", b =>
                {
            ...
            modelBuilder.Entity("Helium.BlazorUI.Entities.HLLGamePlayer", b =>
                {
            ...
            modelBuilder.Entity("Helium.BlazorUI.Entities.HLLGameState", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Helium.BlazorUI.Entities.HLLGameserver", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Helium.BlazorUI.Entities.HLLLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Helium.BlazorUI.Entities.HLLPlayer", b =>
                {
                    b.Property<long>("SteamId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Helium.BlazorUI.Entities.HLLPlayerSession", b =>
                {
                    b.Property<long>("SteamId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Helium.BlazorUI.Entities.Permission", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Helium.BlazorUI.Entities.UserSteamId", b =>
                {
            ...
            modelBuilder.Entity("ApplicationRolePermission", b =>
                {
                    b.HasOne("Helium.BlazorUI.Entities.Permission", null)
                        .WithMany()
                        .HasForeignKey("PermissionsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Helium.BlazorUI.Entities.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("DiscordEmbedDiscordMessageComponent", b =>
                {
                    b.HasOne("Helium.BlazorUI.Entities.DiscordEmbed", null)
                        .WithMany()
                        .HasForeignKey("EmbedsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Helium.BlazorUI.Entities.DiscordMessageComponent", null)
                        .WithMany()
            ...
            modelBuilder.Entity("DiscordModalDiscordModalComponent", b =>
                {
                    b.HasOne("Helium.BlazorUI.Entities.DiscordModalComponent", null)
                        .WithMany()
                        .HasForeignKey("ComponentsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Helium.BlazorUI.Entities.DiscordModal", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Helium.BlazorUI.Entities.DiscordChannel", b =>
                {
                    b.HasOne("Helium.BlazorUI.Entities.DiscordGuild", null)
                        .WithMany("Channels")
            ...
            modelBuilder.Entity("Helium.BlazorUI.Entities.DiscordEmbed", b =>
                {
                    b.HasOne("Helium.BlazorUI.Entities.DiscordAuthor", null)
                        .WithMany("Embeds")
                        .HasForeignKey("DiscordAuthorId");

                    b.HasOne("Helium.BlazorUI.Entities.DiscordChannel", null)
                        .WithMany("Embeds")
            ...
            modelBuilder.Entity("Helium.BlazorUI.Entities.DiscordEmbedFields", b =>
                {
                    b.HasOne("Helium.BlazorUI.Entities.DiscordEmbed", "DiscordEmbed")
                        .WithMany("Fields")
            ...
            modelBuilder.Entity("Helium.BlazorUI.Entities.DiscordMessageComponent", b =>
                {
                    b.HasOne("Helium.BlazorUI.Entities.DiscordChannel", "ActionChannel")
                        .WithMany()
                        .HasForeignKey("ActionChannelId");

                    b.HasOne("Helium.BlazorUI.Entities.DiscordModal", "ActionModal")
            ...
            modelBuilder.Entity("Helium.BlazorUI.Entities.HLLGame", b =>
                {
                    b.HasOne("Helium.BlazorUI.Entities.HLLGameserver", null)
                        .WithMany("Games")
            ...
            modelBuilder.Entity("Helium.BlazorUI.Entities.HLLGamePlayer", b =>
                {
                    b.HasOne("Helium.BlazorUI.Entities.HLLGame", null)
                        .WithMany("Players")
                        .HasForeignKey("GameId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Helium.BlazorUI.Entities.HLLPlayer", null)
