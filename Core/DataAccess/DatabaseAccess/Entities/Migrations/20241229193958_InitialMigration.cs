    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CF_Configurations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CF_Configurations_CF_Configurations_ParentId",
                        column: x => x.ParentId,
                        principalTable: "CF_Configurations",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CF_Configurations_ParentId",
                table: "CF_Configurations",
                column: "ParentId");
        }
